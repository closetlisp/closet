...
Note: Closet is the new name of the `Antilisp programming language`_. While the source code and documentation are being made open source, the downloads and documentation can be found on the Antilisp website.
